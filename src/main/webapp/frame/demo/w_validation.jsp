...
<div class="pageContent">
	...
	<form method="post" class="pageForm required-validate" id="firstform">
		<div class="pageFormContent nowrap" layoutH="97">

			<dl>
				<dt>用户名已存在：</dt>
				<dd>
					<input type="text" name="userName" maxlength="20" class="required isVaildName" />
					<span class="info">class="required isVaildName"</span>
				</dd>
			</dl>
			<dl>
				<dt>必填：</dt>
		...
		<div class="formBar">
			<ul>
				<li><div class="buttonActive"><div class="buttonContent"><button type="button" onclick="submittEvent();">提交</button></div></div></li>
