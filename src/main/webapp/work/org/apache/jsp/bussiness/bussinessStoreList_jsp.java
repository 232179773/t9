...
public final class bussinessStoreList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t店铺名称:<input type=\"text\" name=\"STORE_NAME\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      ...
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"storePageDiv\" class=\"pageContent\"></div>");
    } catch (Throwable t) {
