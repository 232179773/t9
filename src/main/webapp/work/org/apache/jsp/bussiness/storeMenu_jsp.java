...
public final class storeMenu_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("\t<form id=\"storeMenuList_Form\">\r\n");
      out.write("\t<div class=\"searchBar\">\r\n");
      out.write("\t\t<table class=\"searchContent\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t餐厅：\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" id=\"STORE_ID\" name=\"STORE_ID\" maxlength=\"100\" class=\"required\" readOnly=\"true\"/>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"STORE_NAME\" name=\"STORE_NAME\" maxlength=\"100\" class=\"required\" readOnly=\"true\"/>\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"选  择\" onClick=\"selectStore()\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t菜单名： <input type=\"text\" name=\"MENU_NAME\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t菜式：\r\n");
      out.write("\t\t\t\t\t\t<select class=\"combox\" name=\"MENU_STYLE\" showNull=\"true\" sefUrl=\"type=DICT_OPTION&DICT_CODE=STOREMENU_STYLE\"  style=\"width:120px\">\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t分类：\r\n");
      out.write("\t\t\t\t\t<select class=\"combox\" name=\"MENU_CLASS\" showNull=\"true\" sefUrl=\"type=DICT_OPTION&DICT_CODE=STOREMENU_CLASS\"  style=\"width:120px\">\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t口味：\r\n");
      out.write("\t\t\t\t\t<select class=\"combox\" name=\"FLAVOUR\" showNull=\"true\" sefUrl=\"type=DICT_OPTION&DICT_CODE=STOREMENU_FLAVOUR\"  style=\"width:120px\">\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      ...
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"storeMenuList_Div\" class=\"pageContent\"></div>");
    } catch (Throwable t) {
