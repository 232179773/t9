...
public final class dictAnddictOptionEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("<script>\r\n");
      out.write("$(function() {\r\n");
      out.write("\t$('#dictOptionEditForm').setUrlParam();\r\n");
      out.write("\tif($('#PARENT_OPTION_ID').val()){\r\n");
      out.write("\t\t$('#parentOption').show();\r\n");
      out.write("\t\t$('#OPTION_LEVEL').val(urlParam.get('OPTION_LEVEL'));\r\n");
      out.write("\t}\r\n");
      out.write("\tif(urlParam.ID){\r\n");
      out.write("\t\tT9.post('service/dictOption!queryDictOptionById',{ID:urlParam.ID},function(result){\r\n");
      out.write("\t\t\tif(result.success){\r\n");
      out.write("\t\t\t\tdocument.getElementById(\"OPTION_CODE\").setAttribute(\"readOnly\",\"true\");\r\n");
      out.write("\t\t\t\tdocument.getElementById(\"OPTION_VALUE\").setAttribute(\"readOnly\",\"true\");\r\n");
      out.write("\t\t\t\t$(\"#dictOptionEditForm\").setData(result.obj);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      out.write("});\r\n");
      out.write("function saveData() {\r\n");
      out.write("\tvar param=$('#dictOptionEditForm').serializeJSON();\r\n");
      out.write("\tT9.post('service/dictOption!saveDicOption',param,function(result){\r\n");
      out.write("\t\t\tif(result.success){\r\n");
      out.write("\t\t\t\tT9.alert(\"保存成功！\");\r\n");
      out.write("\t\t\t\tparent.$(\"#dictOptionPageDiv\").gridReload();\r\n");
      ...
      out.write("\t<form id=\"dictOptionEditForm\">\r\n");
      out.write("\t\t<input type=\"hidden\" id=\"ID\" name=\"ID\"/>\r\n");
      out.write("\t\t<input type=\"hidden\" id=\"OPTION_LEVEL\" name=\"OPTION_LEVEL\" value=\"1\"/>\r\n");
      out.write("\t\t<div class=\"pageFormContent\" layoutH=\"56\">\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>字典类编码：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"DICT_CODE\" name=\"DICT_CODE\" maxlength=\"50\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p style=\"display:none\" id=\"parentOption\">\r\n");
      out.write("\t\t\t\t<label>父字典项：</label>\r\n");
      out.write("\t\t\t\t<input type=\"hidden\" id=\"PARENT_OPTION_ID\" name=\"PARENT_OPTION_ID\"/>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"PARENT_OPTION_NAME\" name=\"PARENT_OPTION_NAME\" maxlength=\"50\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>字典项编码：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"OPTION_CODE\" name=\"OPTION_CODE\" maxlength=\"50\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>字典项值：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"OPTION_VALUE\" name=\"OPTION_VALUE\" maxlength=\"50\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>字典项名称：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"OPTION_NAME\" name=\"OPTION_NAME\" maxlength=\"50\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>字典项排序：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"ORDER_NO\" name=\"ORDER_NO\" maxlength=\"10\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t</div>\r\n");
