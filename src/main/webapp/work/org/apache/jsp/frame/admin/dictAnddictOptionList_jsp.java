...
public final class dictAnddictOptionList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("\t<form id=\"dictForm\">\r\n");
      out.write("\t<div class=\"searchBar\">\r\n");
      out.write("\t\t<table class=\"searchContent\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t字典类编码:<input type=\"text\" name=\"DICT_CODE\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t字典类名称:<input type=\"text\" name=\"DICT_NAME\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"dictPageDiv\" class=\"pageContent\"></div>\r\n");
      out.write("\r\n");
      out.write("<div id=\"dictOptionPageDiv\" class=\"pageContent\"></div>");
    } catch (Throwable t) {
