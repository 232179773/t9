...
public final class logIPStatList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("    \t    {header:'IP数',key:\"PVSTAT_COUNT\",width:'10%'}\r\n");
      out.write("    \t],\r\n");
      out.write("    \tbuttons:[\r\n");
      out.write("    \t   {name:\"查询\",bclass: 'query'}\r\n");
      out.write("    \t],\r\n");
      out.write("   \t\tformId:'queryLogForm',\r\n");
      out.write("    \turl : 'service/log!ipStat'\r\n");
      out.write("    });\r\n");
      out.write("    \r\n");
