...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("<SCRIPT type=text/javascript>\r\n");
      out.write("$(function(){\t\r\n");
      out.write("\t $('#queryLogForm').setUrlParam();\r\n");
      out.write("    $('#logPageDiv').frontgrid({\r\n");
      out.write("    \tcolumns:[\r\n");
      out.write("    \t   \t{header:'',ctrl:'checkbox',width:'10%',key:\"ID\"},\r\n");
      out.write("    \t    {header:'用户名称',key:\"STAFF_NAME\",width:'10%'},\r\n");
      out.write("    \t    {header:'操作IP',key:\"CLIENT_IP\",width:'10%'},\r\n");
      out.write("    \t    {header:'操作时间',key:\"LOG_TIME\",width:'10%'},\r\n");
      out.write("    \t    {header:'操作模块',key:\"LOG_TITLE\",width:'10%'},\r\n");
      out.write("    \t    {header:'操作内容',key:\"LOG_CONTENT\",width:'30%'}\r\n");
      out.write("    \t],\r\n");
      out.write("    \tbuttons:[\r\n");
      ...
      out.write("    \turl : 'service/log!queryLogList'\r\n");
      ...
      out.write("\tvar param=$(\"#queryLogForm\").serializeJSON();\r\n");
      out.write("\t$(\"#logPageDiv\").gridOptions(param);\r\n");
      ...
      out.write("\t\tT9.post('service/log!deleteLog',param,function(result){\r\n");
      out.write("\t\t\t\tif(result){\r\n");
      ...
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t用户名：<input type=\"text\" name=\"STAFF_NAME\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t操作IP：<input type=\"text\" name=\"CLIENT_IP\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t操作时间：<input type=\"text\" name=\"LOG_TIME_START\" id=\"LOG_TIME_START\" class=\"my97Date\" maxDate=\"#F{$dp.$D('LOG_TIME_END')}\" readonly=\"true\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>~</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"LOG_TIME_END\" id=\"LOG_TIME_END\" class=\"my97Date\" minDate=\"#F{$dp.$D('LOG_TIME_START')}\" readonly=\"true\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
