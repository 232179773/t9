...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("\t<form id=\"menuQueryForm\">\r\n");
      out.write("\t<div class=\"searchBar\">\r\n");
      out.write("\t\t<table class=\"searchContent\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t菜单名称<input type=\"text\" name=\"NAME\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t父菜单名称<input type=\"text\" name=\"PARENT_MENU_ID\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"menuPageDiv\" class=\"pageContent\"></div>");
    } catch (Throwable t) {
