...
public final class pageViewList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("<SCRIPT type=text/javascript>\r\n");
      out.write("$(function(){\r\n");
      out.write("    $('#logPageDiv').frontgrid({\r\n");
      out.write("    \tcolumns:[\r\n");
      out.write("    \t    {header:'操作时间',key:\"PVSTAT_TYPE\",width:'10%'},\r\n");
      out.write("    \t    {header:'PV值',key:\"PVSTAT_COUNT\",width:'10%',cellRenderer:function(value,record){\r\n");
      out.write("    \t    \tvar type=$(':radio[checked]').val();\r\n");
      out.write("    \t    \tif(type=='month'||type=='year'){\r\n");
      out.write("    \t    \t\treturn '<a onclick=\"openDetail(\\''+type+'\\',\\''+record.PVSTAT_TYPE+'\\')\">'+value+'</a>';\r\n");
      out.write("    \t    \t}\r\n");
      out.write("    \t    \treturn value;\r\n");
      out.write("    \t    }}\r\n");
      out.write("    \t],\r\n");
      out.write("    \tbuttons:[\r\n");
      out.write("    \t   {name:\"查询\",bclass: 'query'}\r\n");
      out.write("    \t],\r\n");
      out.write("   \t\tformId:'queryLogForm',\r\n");
      out.write("    \turl : 'service/log!pvStat'\r\n");
      out.write("    });\r\n");
      out.write("    \r\n");
      out.write("    $('#STAT_CYCLE_DAY').click(function(){\r\n");
      out.write("    \t$('#timeEndSpan').hide();\r\n");
      out.write("    \t$(\"#logPageDiv\").gridReload();\r\n");
      out.write("    });\r\n");
      out.write("    \r\n");
      out.write("    $('#STAT_CYCLE_MONTH').click(function(){\r\n");
      out.write("    \t$('#timeEndSpan').show();\r\n");
      out.write("    \t$(\"#logPageDiv\").gridReload();\r\n");
      out.write("    });\r\n");
      out.write("    \r\n");
      out.write("    $('#STAT_CYCLE_YEAR').click(function(){\r\n");
      out.write("    \t$('#timeEndSpan').hide();\r\n");
      out.write("    \t$(\"#logPageDiv\").gridReload();\r\n");
      out.write("    });\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("function openDetail(type,value){\r\n");
      out.write("\tvar param={};\r\n");
      out.write("\tif(type=='month'){\r\n");
      out.write("\t\tvar param={url : 'frame/admin/logList.jsp?LOG_TIME_START='+value+'&LOG_TIME_END='+value,\r\n");
      out.write("\t\t\t\ttitle:value+'明细'\r\n");
      out.write("\t\t};\r\n");
      out.write("\t}else if(type=='year'){\r\n");
      out.write("\t\tvar param={url : 'frame/admin/logList.jsp?LOG_TIME_START='+value+'01'+'&LOG_TIME_END='+value,\r\n");
      out.write("\t\t\t\ttitle:value+'明细'\r\n");
      out.write("\t\t};\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t<form id=\"queryLogForm\">\r\n");
      out.write("\t<div class=\"searchBar\">\r\n");
      out.write("\t\t<table class=\"searchContent\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t统计周期：<input type=\"radio\" id=\"STAT_CYCLE_DAY\" name=\"STAT_CYCLE\" checked value=\"day\">天\r\n");
      out.write("\t\t\t\t\t<input type=\"radio\" id=\"STAT_CYCLE_MONTH\" name=\"STAT_CYCLE\" value=\"month\">月\r\n");
      out.write("\t\t\t\t\t<input type=\"radio\" id=\"STAT_CYCLE_YEAR\" name=\"STAT_CYCLE\" value=\"year\">年\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t统计时间：<input type=\"text\" name=\"LOG_TIME_START\" id=\"LOG_TIME_START\" class=\"my97Date\" maxDate=\"#F{$dp.$D('LOG_TIME_END')||'%y-%M-%d'}\" readonly=\"true\"/>\r\n");
      out.write("\t\t\t\t\t<span id=\"timeEndSpan\" style=\"display:none\">&nbsp;&nbsp;~&nbsp;&nbsp;<input type=\"text\" name=\"LOG_TIME_END\" id=\"LOG_TIME_END\" class=\"my97Date\" minDate=\"#F{$dp.$D('LOG_TIME_START')}\" readonly=\"true\"/></span>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"logPageDiv\" class=\"pageContent\"></div>\r\n");
    } catch (Throwable t) {
