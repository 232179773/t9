...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("<script>\r\n");
      out.write("$(function() {\r\n");
      out.write("\tif(urlParam.get('PARENTROLEID')){\r\n");
      out.write("\t\t$(\"#PARENTROLEID\").val(urlParam.get('PARENTROLEID'));\r\n");
      out.write("\t\t$(\"#PARENTROLENAME\").val(urlParam.get('PARENTROLENAME'));\r\n");
      out.write("\t\t$(\"#parentRole\").show();\r\n");
      out.write("\t}\r\n");
      out.write("\tif (urlParam.ID) {\r\n");
      out.write("\t\tT9.post('service/role!queryRoleById', {\r\n");
      out.write("\t\t\tID : urlParam.ID\r\n");
      out.write("\t\t}, function(result) {\r\n");
      out.write("\t\t\tif (result.success) {\r\n");
      out.write("\t\t\t\t$(\"#roleEditForm\").setData(result.obj);\r\n");
      out.write("\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\tvar param = $('#roleEditForm').serializeJSON();\r\n");
      out.write("\tif (!$(\"#roleEditForm\").isValid()) {\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t} \r\n");
      out.write("\tvar url = \"\";\r\n");
      out.write("\tif (urlParam.ID) {\r\n");
      out.write("\t\turl = \"service/role!updateRole\";\r\n");
      out.write("\t} else {\r\n");
      out.write("\t\turl = \"service/role!saveRole\";\r\n");
      out.write("\t}\r\n");
      out.write("\tT9.post(url, param, function(result) {\r\n");
      out.write("\t\tif (result.success) {\r\n");
      out.write("\t\t\tT9.alert(\"保存成功！\");\r\n");
      out.write("\t\t\tparent.$(\"#rolePageDiv\").gridReload();\r\n");
      ...
      out.write("\t<form id=\"roleEditForm\" data-validator-option=\"{valid:saveData}\">\r\n");
      out.write("\t\t<input type=\"hidden\" id=\"ID\" name=\"ID\" maxlength=\"25\" />\r\n");
      out.write("\t\t<div class=\"pageFormContent\" layoutH=\"56\">\r\n");
      out.write("\t\t\t<p style=\"display:none\" id=\"parentRole\">\r\n");
      out.write("\t\t\t\t<label>父权限名称：</label> \r\n");
      out.write("\t\t\t\t<input type=\"hidden\" id=\"PARENTROLEID\" name=\"PARENTROLEID\" />\t\t\t\t\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"PARENTROLENAME\" name=\"PARENTROLENAME\" />\r\n");
      out.write("\t\t\t\t<span class=\"info\"></span>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>权限名称：</label> <input type=\"text\" id=\"NAME\" name=\"NAME\"\r\n");
      out.write("\t\t\t\t\tmaxlength=\"30\"  data-rule=\"required\"/> <span class=\"info\"></span>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>备注：</label> <input type=\"text\" id=\"REMARK\" name=\"REMARK\"\r\n");
