...
public final class systemConfigList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("\t<form id=\"systemConfigListForm\">\r\n");
      out.write("\t<div class=\"searchBar\">\r\n");
      out.write("\t\t<table class=\"searchContent\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t系统参数名称： <input type=\"text\" name=\"paramName\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"systemConfigListDiv\" class=\"pageContent\"></div>");
    } catch (Throwable t) {
