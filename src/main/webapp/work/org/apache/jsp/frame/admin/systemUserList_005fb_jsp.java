...
public final class systemUserList_005fb_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("\t<form id=\"systemUserList_bForm\">\r\n");
      out.write("\t<div class=\"searchBar\">\r\n");
      out.write("\t\t<table class=\"searchContent\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t账户类型： \r\n");
      out.write("\t\t\t\t\t<select class=\"combox\" name=\"USER_RIGHTTYPE\" id=\"USER_RIGHTTYPE\" showNull=\"true\" \r\n");
      out.write("\t\t\t\t\t\tsefUrl=\"type=DICT_OPTION&DICT_CODE=USER_RIGHTTYPE\"  style=\"width:120px\"></select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t登录账户： <input type=\"text\" name=\"LOGIN_CODE\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t名称： <input type=\"text\" name=\"NAME\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t角色名： <input type=\"hidden\" name=\"ROLE_ID\" id=\"ROLE_ID\"/>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"ROLE_NAME\" id=\"ROLE_NAME\"/>\r\n");
      ...
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"systemUserList_bDiv\" class=\"pageContent\"></div>");
    } catch (Throwable t) {
