...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("\t\tT9.post('service/account!queryAccountById',{ID:urlParam.ID},function(result){\r\n");
      out.write("\t\t\tif(result.success){\r\n");
      out.write("\t\t\t\t$(\"#accountEditForm\").setData(result.obj);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\tvar param=$('#accountEditForm').serializeJSON();\r\n");
      out.write("\tvar url =  'service/account!saveAccount' ;\r\n");
      out.write("\tif(urlParam.ID){\r\n");
      out.write("\t\turl = 'service/account!updateAccount';\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t\t\tparent.$(\"#accountPageDiv\").gridReload();\r\n");
      ...
      out.write("\t<form id=\"accountEditForm\" data-validator-option=\"{valid:saveData}\">\r\n");
      ...
      out.write("\t\t\t\t<input type=\"text\" id=\"SITE_NAME\" name=\"SITE_NAME\" maxlength=\"100\" data-rule=\"required\"/>\r\n");
      out.write("\t\t\t\t<span class=\"info\"></span>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t    <p>\r\n");
      out.write("\t\t\t\t<label>网站URL：</label>\r\n");
      out.write("\t\t\t\t<input   type=\"text\" id=\"NAME\" name=\"NAME\" maxlength=\"100\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t    <p>\r\n");
      out.write("\t\t\t\t<label>帐号：</label>\r\n");
      out.write("\t\t\t\t<input data-rule=\"required\" type=\"text\" id=\"SITE_ACCOUNT\" name=\"SITE_ACCOUNT\" maxlength=\"30\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t    <p>\r\n");
      out.write("\t\t\t\t<label>昵称：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"NICK_NAME\" name=\"NICK_NAME\" maxlength=\"30\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t    <p>\r\n");
      out.write("\t\t\t\t<label>邮箱：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"EMAIL\" name=\"EMAIL\" maxlength=\"30\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t    <p>\r\n");
      out.write("\t\t\t\t<label>手机号：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"MOBILE_PHONE\" name=\"MOBILE_PHONE\" maxlength=\"30\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t    <p>\r\n");
      out.write("\t\t\t\t<label>登录密码：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"LOGIN_PASSWORD\" name=\"LOGIN_PASSWORD\" maxlength=\"30\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t    <p>\r\n");
      out.write("\t\t\t\t<label>支付密码：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"PAY_PASSWORD\" name=\"PAY_PASSWORD\" maxlength=\"30\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t    <p>\r\n");
      out.write("\t\t\t\t<label>支付渠道：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"PAY_TYPE\" name=\"PAY_TYPE\" maxlength=\"30\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t    <p>\r\n");
      out.write("\t\t\t\t<label>注册时间：</label>\r\n");
      out.write("\t\t\t\t<input data-rule=\"required\" type=\"text\" id=\"REGISTER_TIME\" name=\"REGISTER_TIME\" class=\"my97Date\"  readonly=\"true\" />\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
