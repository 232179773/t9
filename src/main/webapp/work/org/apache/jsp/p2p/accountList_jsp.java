...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t支付渠道:<input type=\"text\" name=\"PAY_TYPE\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t注册时间：<input type=\"text\" name=\"REGISTER_TIME_START\" id=\"REGISTER_TIME_START\" class=\"my97Date\" maxDate=\"#F{$dp.$D('REGISTER_TIME_END')}\" readonly=\"true\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>~</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"REGISTER_TIME_END\" id=\"REGISTER_TIME_END\" class=\"my97Date\" minDate=\"#F{$dp.$D('REGISTER_TIME_START')}\" readonly=\"true\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"accountPageDiv\" class=\"pageContent\"></div>");
    } catch (Throwable t) {
