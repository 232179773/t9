...
public final class accountLogEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("\t\t}\r\n");
      out.write("\t\tT9.post('service/accountLog!queryAccountLogById',{ID:urlParam.ID},function(result){\r\n");
      out.write("\t\t\tif(result.success){\r\n");
      out.write("\t\t\t\t$(\"#accountLogEditForm\").setData(result.obj);\r\n");
      ...
      out.write("\tvar param=$('#accountLogEditForm').serializeJSON();\r\n");
      out.write("\tvar url =  'service/accountLog!saveAccountLog' ;\r\n");
      out.write("\tif(urlParam.ID){\r\n");
      out.write("\t\turl = 'service/accountLog!updateAccountLog';\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t\t\tparent.$(\"#accountLogPageDiv\").gridReload();\r\n");
      ...
      out.write("\t<form id=\"accountLogEditForm\"  data-validator-option=\"{valid:saveData}\" >\r\n");
      out.write("\t\t<input type=\"hidden\" id=\"ID\" name=\"ID\" maxlength=\"25\"/>\r\n");
      out.write("\t\t<div class=\"pageFormContent\" layoutH=\"56\">\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>网站名称：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"SITE_NAME\" name=\"SITE_NAME\" maxlength=\"100\" class=\"required\"/>\r\n");
      out.write("\t\t\t\t<span class=\"info\"></span>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>流水类型：</label>\r\n");
      out.write("\t\t\t\t<select class=\"combox\" name=\"LOG_TYPE\" sefUrl=\"type=DICT_OPTION&DICT_CODE=P2P_ACCOUNT_LOG_TYPE\">\r\n");
      out.write("\t\t\t\t</select>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>金额：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"MONEY\" name=\"MONEY\" maxlength=\"25\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>发生时间：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"DUE_TIME\" id=\"DUE_TIME\" class=\"my97Date\"  readonly=\"true\" />\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>标类型：</label>\r\n");
      out.write("\t\t\t\t<select class=\"combox\" name=\"TENDER_TYPE\" sefUrl=\"type=DICT_OPTION&DICT_CODE=P2P_BID_TYPE\">\r\n");
      out.write("\t\t\t\t</select>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>投标期限：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"TENDER_DURATION\" name=\"TENDER_DURATION\" maxlength=\"100\" class=\"required\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>还款方式：</label>\r\n");
      out.write("\t\t\t\t<select class=\"combox\" name=\"REPAMENT_TYPE\" sefUrl=\"type=DICT_OPTION&DICT_CODE=P2P_REPAMENT_TYPE\">\r\n");
      out.write("\t\t\t\t</select>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>利率：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"INTEREST_RATE\" name=\"INTEREST_RATE\" maxlength=\"100\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>奖励：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"REWARD\" name=\"REWARD\" maxlength=\"100\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>利息管理费：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"INTEREST_COST\" name=\"INTEREST_COST\" maxlength=\"100\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>投标标题：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"BID_TITLE\" name=\"BID_TITLE\" maxlength=\"100\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t \t<label>投标URL：</label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"BID_URL\" name=\"BID_URL\" maxlength=\"100\"/>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t\t<p>\r\n");
      out.write("\t\t\t\t<label>还款状态：</label>\r\n");
      out.write("\t\t\t\t<select class=\"combox\" name=\"GATHER_STATE\" sefUrl=\"type=DICT_OPTION&DICT_CODE=P2P_GATHER_STATE\">\r\n");
      out.write("\t\t\t\t</select>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t</div>\r\n");
