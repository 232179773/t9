...
public final class accountLogList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("\t<form id=\"accountLogForm\">\r\n");
      out.write("\t<div class=\"searchBar\">\r\n");
      out.write("\t\t<table class=\"searchContent\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t网站名称:<input type=\"text\" name=\"SITE_NAME\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t流水类型： \r\n");
      out.write("\t\t\t\t\t<select class=\"combox\" name=\"LOG_TYPE\" sefUrl=\"type=DICT_OPTION&DICT_CODE=P2P_ACCOUNT_LOG_TYPE\"\r\n");
      out.write("\t\t\t\t\t\tshowNull=\"true\" initVal=\"gather\" style=\"width:120px\">\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t还款状态： \r\n");
      out.write("\t\t\t\t\t<select class=\"combox\" name=\"GATHER_STATE\" sefUrl=\"type=DICT_OPTION&DICT_CODE=P2P_GATHER_STATE\"\r\n");
      out.write("\t\t\t\t\t\tshowNull=\"true\" style=\"width:120px\">\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t发生时间：<input type=\"text\" name=\"DUE_TIME_START\" id=\"DUE_TIME_START\" class=\"my97Date\" maxDate=\"#F{$dp.$D('DUE_TIME_END')}\" readonly=\"true\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>~</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"DUE_TIME_END\" id=\"DUE_TIME_END\" class=\"my97Date\" minDate=\"#F{$dp.$D('DUE_TIME_START')}\" readonly=\"true\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"accountLogPageDiv\" class=\"pageContent\"></div>");
    } catch (Throwable t) {
