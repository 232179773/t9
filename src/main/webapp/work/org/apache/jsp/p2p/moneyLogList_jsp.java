...
public final class moneyLogList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(url.endsWith("jsp")){
	...
	if(file.exists()){
      ...
      out.write("\t<form id=\"moneyLogForm\">\r\n");
      ...
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"moneyLogPageDiv\" class=\"pageContent\"></div>");
    } catch (Throwable t) {
